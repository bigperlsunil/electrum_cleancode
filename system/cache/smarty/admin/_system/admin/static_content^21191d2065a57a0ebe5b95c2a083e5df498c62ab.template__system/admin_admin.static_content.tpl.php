<?php /* Smarty version Smarty-3.1.19, created on 2016-09-27 19:32:22
         compiled from "template__system/admin_admin:/home/electrum/public_html/templates/_system/admin/static_content/static_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:70294891457ea7bee40e804-37603696%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '21191d2065a57a0ebe5b95c2a083e5df498c62ab' => 
    array (
      0 => 'template__system/admin_admin:/home/electrum/public_html/templates/_system/admin/static_content/static_content.tpl',
      1 => 1400843946,
      2 => 'template__system/admin_admin',
    ),
  ),
  'nocache_hash' => '70294891457ea7bee40e804-37603696',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ea7bee4c86e5_24796945',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ea7bee4c86e5_24796945')) {function content_57ea7bee4c86e5_24796945($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/home/electrum/public_html/system/ext/Smarty/libs/plugins/function.cycle.php';
...
/icons/note32.png" border="0" alt="" class="titleicon" /><?php $_smarty_tpl->smarty->_tag_stack[] = array('tr', array()); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Static Content<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</h1>
...
Add a New Static Content<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</legend>
...
"<?php if ($_smarty_tpl->tpl_vars['language']->value['id']==$_smarty_tpl->tpl_vars['language']->value['is_default']) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['language']->value['caption'];?>
</option>
						<?php } ?>
					</select>
				</td>
...
" class="greenButton" id="submitAdd" />
					</div>
				</td>
			</tr>
		</table>
...
$_smarty_tpl->tpl_vars['page']->_loop = true;
 $_smarty_tpl->tpl_vars['sid']->value = $_smarty_tpl->tpl_vars['page']->key;
?>
			<tr class=<?php echo smarty_function_cycle(array('values'=>"'oddrow', 'evenrow'"),$_smarty_tpl);?>
>
				<td><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['id'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
</td>
				<td><?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['page']->value['name'], ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
&nbsp;</td>
				<td>
					<?php  $_smarty_tpl->tpl_vars['language'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['language']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['languages']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
$_smarty_tpl->tpl_vars['language']->_loop = true;
?>
						<?php if ($_smarty_tpl->tpl_vars['language']->value['id']==$_smarty_tpl->tpl_vars['page']->value['lang']) {?><?php echo $_smarty_tpl->tpl_vars['language']->value['caption'];?>
<?php }?>
					<?php } ?>
				</td>
				<td><a href="?action=edit&amp;page_sid=<?php echo $_smarty_tpl->tpl_vars['sid']->value;?>
&amp;pageid=<?php echo $_smarty_tpl->tpl_vars['page']->value['id'];?>
...
Edit<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
				...
				<?php if (!$_smarty_tpl->tpl_vars['page']->value['isDefault']) {?>
					<td><a href="?action=delete&amp;page_sid=<?php echo $_smarty_tpl->tpl_vars['sid']->value;?>
...
Are you sure you want to delete this Static Content<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
?')" title="<?php $_smarty_tpl->smarty->_tag_stack[] = array('tr', array()); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
