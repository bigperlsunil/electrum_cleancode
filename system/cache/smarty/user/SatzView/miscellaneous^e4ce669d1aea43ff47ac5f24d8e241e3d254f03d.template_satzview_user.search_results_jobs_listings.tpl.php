<?php /* Smarty version Smarty-3.1.19, created on 2016-09-30 18:36:48
         compiled from "template_satzview_user:/home/electrum/public_html/templates/SatzView/classifieds/search_results_jobs_listings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:49243633657ee6368ac88d9-54221275%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e4ce669d1aea43ff47ac5f24d8e241e3d254f03d' => 
    array (
      0 => 'template_satzview_user:/home/electrum/public_html/templates/SatzView/classifieds/search_results_jobs_listings.tpl',
      1 => 1393405710,
      2 => 'template_satzview_user',
    ),
  ),
  'nocache_hash' => '49243633657ee6368ac88d9-54221275',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57ee6368d0e089_58998277',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ee6368d0e089_58998277')) {function content_57ee6368d0e089_58998277($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/home/electrum/public_html/system/ext/Smarty/libs/plugins/function.cycle.php';
...
><span class="strong"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['listing']->value['Title'], ENT_QUOTES, 'UTF-8', true);?>
					...
					<div class="listing-info">
						<div class="left-side">
							<span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['listing']->value['CompanyName'], ENT_QUOTES, 'UTF-8', true);?>
</span>
...
: <?php $_smarty_tpl->smarty->_tag_stack[] = array('tr', array('metadata'=>$_smarty_tpl->tpl_vars['METADATA']->value['listing']['activation_date'])); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array('metadata'=>$_smarty_tpl->tpl_vars['METADATA']->value['listing']['activation_date']), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
"<?php }?>>
			<td>
				<div class="listing-section <?php if ($_smarty_tpl->tpl_vars['show_brief_or_detailed']->value=='brief') {?>brief-view<?php }?>">
					<div class="listing-title">
						<a name="listing_<?php echo $_smarty_tpl->tpl_vars['listing']->value['id'];?>
"></a>
...
/"><?php echo $_smarty_tpl->tpl_vars['listing']->value['user']['CompanyName'];?>
</a>
							<?php echo SJB_LocationManager::locationFormat(array('location'=>$_smarty_tpl->tpl_vars['listing']->value['Location'],'format'=>"short"),$_smarty_tpl);?>
