...
class SJB_Users_SubAccounts extends SJB_Function
{
	...
	public function execute()
	{
		...
		if (!empty($currentUserInfo['subuser']) && SJB_Request::getVar('user_id', 0) != $currentUserInfo['subuser']['sid']) {
			...
			case 'new':
				...
				if ($form_submitted && $registration_form->isDataValid($errors)) {
					...
					$subuserPermissions = array(
						...
						'subuser_use_screening_questionnaires' => array ('title' => 'Manage Questionnaires', 'value' => 'deny'),
					);
