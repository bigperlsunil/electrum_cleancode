...
class SJB_System
{
	...
	public static function boot()
	{
		...
		$loader->register();
		include SJB_System::getSystemSettings('EXT_LIBRARY_DIR') . 'vendor/autoload.php';
	...
	public static function init()
	{
		...
		SJB_System::setGlobalTemplateVariable('default_currency', SJB_CurrencyManager::getDefaultCurrency());
