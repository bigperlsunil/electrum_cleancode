	...
	public function isAccessible()
	{
		...
		switch ($plugin) {
			...
			case 'FacebookSocialPlugin':
				...
				break;
			case 'FacebookApplicationPlugin':
			...
			case 'BeyondPlugin':
				...
				break;
			case 'JobG8IntegrationPlugin':
				$this->setPermissionLabel('set_jobg8plugin');
				break;
			case 'MailChimpPlugin':
				$this->setPermissionLabel('set_mailchimpplugin');
				break;
			case 'MobilePlugin':
				$this->setPermissionLabel('set_mobileplugin');
				break;
