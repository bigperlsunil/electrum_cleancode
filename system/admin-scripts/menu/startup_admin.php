	...
	public function execute()
	{
		...
		(
			...
			(
				...
				'perm_label' => array('manage_plug-ins', 'set_phpbb_plug-in', 'set_facebook_plug-in', 'set_facebook_app_plug-in',
									...
									'set_simplyhiredplugin', 'set_googleplusplugin', 'set_googleanalyticsplugin',
									'set_beyondplugin', 'set_jobg8plugin', 'set_mailchimpplugin', 'set_mobileplugin'),
			),
			array
			(
