...
class SJB_SubAdminAcl extends SJB_Acl
{
	...
	public function getResources($type = 'all', $role = '')
	{
		...
		$resources = array(
			...
			'set_facebook_app_plug-in' => array(
				'title' => 'Set Facebook Application Plug-in',
				'group' => 'system configuration',
				'type' => 'subadmin',
				'parent' => 'manage_plug-ins',
			),
			...
			'set_jobg8plugin' => array(
				'title' => 'Set JobG8 Plugin',
				'group' => 'system configuration',
				'type' => 'subadmin',
				'parent' => 'manage_plug-ins',
			),
			...
			'set_mailchimpplugin' => array(
				'title' => 'Set Mailchimp Plugin',
				'group' => 'system configuration',
				'type' => 'subadmin',
				'parent' => 'manage_plug-ins',
			),
			'set_mobileplugin' => array(
				'title' => 'Set Mobile Plugin',
				'group' => 'system configuration',
				'type' => 'subadmin',
				'parent' => 'manage_plug-ins',
			),
