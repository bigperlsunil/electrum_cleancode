	...
	public function execute()
	{
		...
		switch ($action) {
			...
			case'mapping':
				...
				$salaryTypeFieldSID = SJB_ListingFieldManager::getListingFieldSIDByID($mapper->salaryMappingFieldID);
				...
				$tp->assign('salaryMappingFieldValues', $mapper->getMappingInfoByType($mapper::SALARY_MAPPING_TYPE));
				...
				$tp->assign('sjbSalaryTypes', SJB_ListingFieldDBManager::getListValuesBySID($salaryTypeFieldSID));
				...
				$tp->assign('salaryMappingFieldID', $mapper->salaryMappingFieldID);
