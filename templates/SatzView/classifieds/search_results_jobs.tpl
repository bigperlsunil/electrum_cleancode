		...
		<div class="headerBgBlock">
			{if $is_company_profile_page}
				...
				{if $userInfo.CompanyName ne '' }
					...
					<div class="Results" id="compProfileInfo">{tr}Jobs by $companyName{/tr|escape:'html'}</div>
				{/if}
			{else}
				<div class="Results results-title">[[Job Search Results]]</div>
			{/if}
	...
	<div class="results-paging">
		...
		<div class="topNavBar">
			<div class="numberResults">
				...
				<p>[[Results:]] <span>{$listings_number}</span> {if $listings_number == 1}[[Job]]{else}[[jobs]]{/if}</p>
