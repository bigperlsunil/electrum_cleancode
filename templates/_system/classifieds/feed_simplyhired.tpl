...
<job>
	...
	<description>
		...
		<required-skills><![CDATA[{$listing.JobRequirements|strip_tags:false|clrNonPrintedChars}]]></required-skills>
		<required-education/>
		<required-experience/>
	...
	<location>
		<address><![CDATA[{$listing.Address|clrNonPrintedChars}]]></address>
	...
	<contact>
		<name><![CDATA[{$listing.user.ContactName|clrNonPrintedChars}]]></name>
