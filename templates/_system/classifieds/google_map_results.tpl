...
{foreach from=$listings item=listing name=listings}
	{if $listing.latitude && $listing.longitude}
		{if $listing.type.id != 'Resume'}
			...
			"<h3><a href=\"{$GLOBALS.site_url}/display-job/{$listing.id}/{$listing.Title|regex_replace:"/[\\/\\\:*?\"<>|%#$\s]/u":"-"|escape:"url"}.html?searchId={$searchId}&amp;page={$listing_search.current_page}\" target=\"_blank\"><strong>{$listing.Title|escape:'html'}<\/strong><\/a><\/h3>" +
			"<strong>[[Company]]:<\/strong> " +
				'<a href="{$GLOBALS.site_url}/company/{$listing.user.id}/{$listing.user.CompanyName|regex_replace:"/[\s\/\\\\]/u":"-"|escape:"url"}/">{$listing.user.CompanyName|escape:"html"}<\/a>' +
			'<br />' +
			...
			{/if}
			'<\/span>' +
			"<a href=\"{$GLOBALS.site_url}/display-job/{$listing.id}/{$listing.Title|regex_replace:"/[\\/\\\:*?\"<>|%#$\s]/u":"-"|escape:"url"}.html?searchId={$searchId}&amp;page={$listing_search.current_page}\" target=\"_blank\">[[View job details]]<\/a>" +
			...
			"<h3><a href=\"{$GLOBALS.site_url}/display-resume/{$listing.id}/{$listing.Title|regex_replace:"/[\\/\\\:*?\"<>|%#$\s]/u":"-"|escape:"url"}.html?searchId={$searchId}&amp;page={$listing_search.current_page}\" target=\"_blank\"><strong>{$listing.Title|escape:'html'}<\/strong><\/a><\/h3>" +
			...
			{/if}
			'<\/span>' +
			"<a href=\"{$GLOBALS.site_url}/display-resume/{$listing.id}/{$listing.Title|regex_replace:"/[\\/\\\:*?\"<>|%#$\s]/u":"-"|escape:"url"}.html?searchId={$searchId}&amp;page={$listing_search.current_page}\" target=\"_blank\">[[View resume details]]<\/a>" +
		{/if}
		']]><\/marker>' +
		'\n' +
	{/if}
