...
<description><![CDATA[{$listing.JobDescription|strip_tags:false|clrNonPrintedChars} {$listing.JobRequirements|strip_tags:false|clrNonPrintedChars}]]></description>
...
<experience><![CDATA[{$listing.JobExpirience|clrNonPrintedChars}]]></experience>
</job>
{/foreach}
</source>