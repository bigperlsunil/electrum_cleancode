				...
				<tr class="{cycle values = 'evenrow,oddrow' advance=true}">
					...
					<td class="compLogo" colspan="2">
						<div class="text-center">
							<a href="{$GLOBALS.site_url}/company/{$user_sid}/{$companyNameAlias|regex_replace:"/[\s\/\\\\]/u":"-"|escape:"url"}/">{display property='Logo' object_sid=$user_sid}</a>
						</div>
					</td>
					<td>
						<span class="strong">
							<a href="{$GLOBALS.site_url}/company/{$user_sid}/{$companyNameAlias|regex_replace:"/[\s\/\\\\]/u":"-"|escape:"url"}/">{display property='CompanyName' object_sid=$user_sid}</a>
						</span>
					</td>
