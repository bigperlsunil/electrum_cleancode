...
<span class="productTypeComment">
	[[To set up recurring billing in <a target="_blank" href="https://www.2checkout.com/referral?r=10765079f5">2Checkout</a> you need to set an email address in <a target="_blank" href="https://www.2checkout.com/referral?r=10765079f5">2Checkout</a> for subscription notifications to be sent to (you'll need to do this only once);]]<br/>
	<br/>
...
<span class="productTypeComment">
	<br/>
	<a target="_blank" href="http://reseller.authorize.net/application/?resellerId=29761">[[Sign up for Authorize .Net account here]]</a><br/>
