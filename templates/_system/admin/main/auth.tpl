...
<head>
	...
	<title>Electrum Jobs[[Admin Panel]]</title>
...
<body>
	<div id="loginForm">
		<div id="headerLogo">
			<img src="{image}authLogo.png" border="0" width="150" /><br/>
	...
	<div class="clr"></div>
	<div id="copyright">[[Copyright]]  {$smarty.now|date_format:"%Y"} &copy; ElectrumJobs.com [[All rights reserved]]</div>
</body>
</html>