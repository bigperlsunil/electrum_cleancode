		...
		<table>
								...
								<table width="100%">
									{foreach from=$fields item=fild}
										...
										<tr>
											...
											<td class="td_height"><div id='defaultValue_{$fieldId}'><span style='font-size:11px;'>[[{$fild.caption}]]:</span><br /><input type="text" name='default_value[{$fieldId}]' id='id_{$fieldId}' value="{$default_value.$fieldId|escape:'html'}"  /></div></td>
										</tr>
										{/if}
									{/foreach}
								</table>
			...
			<tr id="clearTable">
				<td colspan='2'>
					...
					<textarea rows="15" cols="119" name="custom_script" id="custom_script">{$custom_script|escape:'html'}</textarea>
					<div style='font-size:11px; font-style:italic;'>
						{assign var="listing" value="listing"}
						{assign var="skip" value="skip"}
			...
			<tr id="clearTable">
				<td colspan='2'>
					...
					<textarea rows="15" cols="119" name="custom_script_users" id="custom_script_users">{$custom_script_users|escape:'html'}</textarea>
					<div style='font-size:11px; font-style:italic;'>
...
function deleteLogo()
{
	$.get('{$GLOBALS.site_url}/edit-import/?id={$id}&logo_id={$xml_logo}', function(data){
		location.href = "{$GLOBALS.site_url}/edit-import/?id={$id}";
	});
}
