	...
	<div id="file_{if $complexField}{$complexField}[{$id}][{$complexStep}]{else}{$id}{/if}">
		{if $complexField && $filesInfo[$complexStep].file_name ne null}
			<div class="complex-view-file-caption">
				...
				| <a class="delete_file_complex"
					 ...
					 listing_id="{if $copy_listing_id}{$copy_listing_id}{elseif $listing_id}{$listing_id}{else}{$listing.id}{/if}"
					 field_id="{$complexField}:{$id}:{$complexStep}"
					 file_id="{$filesInfo.$complexStep.file_id}"
					 href="{$GLOBALS.site_url}/classifieds/delete-complex-file/?listing_id={if $copy_listing_id}{$copy_listing_id}{else}{$listing.id}{/if}&amp;field_id={$complexField}:{$id}:{$complexStep}&amp;file_id={$filesInfo.$complexStep.file_id}&amp;form_token={$form_token}">[[Remove]]</a>
		...
		{if !$complexField && $value.file_name ne null}
			...
			| <a class="delete_file"
				 ...
				 href="{$GLOBALS.site_url}/classifieds/delete-uploaded-file/?listing_id={if $copy_listing_id}{$copy_listing_id}{else}{$listing.id}{/if}&amp;field_id={$id}&amp;form_token={$form_token}">[[Remove]]</a>
