		...
		<fieldset>
			...
			<div class="inputField">
				<ul class="sub-user-permissions">
					...
					<li><input type="checkbox" {if $acl->isAllowed('subuser_use_screening_questionnaires', $user_info.sid)} checked="checked"{/if} name="subuser_use_screening_questionnaires" value="allow" />[[Manage Questionnaires]]</li>
				</ul>
			</div>
		</fieldset>
		<fieldset>
